...
(function (window) {
    ...
    XNColorPicker.prototype = {
        ...
        rendGradientDom: function rendGradientDom() {},
        ...
        addEvent: function addEvent() {
            ...
            that.dom.addEventListener("mousedown", function (e) {
                ...
                if ($t[0] == _this.dom && _this.option.canMove) {
            ...
            document.addEventListener("mousemove", function (e) {
                if (t) {
                    ...
                    //如果移动渐变滑块
                    var per = ((e.clientX - $(_this.dom).find(".gradient-colors")[0].getBoundingClientRect().left) * 100 / $(_this.dom).find(".gradient-colors")[0].getBoundingClientRect().width).toFixed(1);
                    ...
                    var angle = ((e.clientX - $(_this.dom).find(".gradient-angle")[0].getBoundingClientRect().left) * 360 / $(_this.dom).find(".gradient-angle")[0].getBoundingClientRect().width).toFixed(1);
                    if (angle < 0) {
                        angle = 0;
                    }
                    if (angle > 360) {
            ...
            var mousedownFunc = function mousedownFunc(e) {
                ...
                $(_this.dom).find(".color-slidedown").not($(e.target).parents('.color-slidedown')[0]).removeClass('down');
            };
        ...
        changeColorFormatType: function changeColorFormatType() {
