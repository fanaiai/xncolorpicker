...
/*!****************************************************************************!*\
  ...
  \****************************************************************************/function(r,o,e){var n,t,a=function(){return n=void 0===n?Boolean(window&&document&&document.all&&!window.atob):n},i=(t={},function(r){if(void 0===t[r]){var o=document.querySelector(r);if(window.HTMLIFrameElement&&o instanceof window.HTMLIFrameElement)try{o=o.contentDocument.head}catch(r){o=null}t[r]=o}return t[r]}),c=[];function d(r){for(var o=-1,n=0;n<c.length;n++)if(c[n].identifier===r){o=n;break}return o}function s(r,o){for(var n={},t=[],e=0;e<r.length;e++){var i=r[e],l=o.base?i[0]+o.base:i[0],a=n[l]||0,s="".concat(l," ").concat(a);n[l]=a+1;a=d(s),i={css:i[1],media:i[2],sourceMap:i[3]};-1!==a?(c[a].references++,c[a].updater(i)):c.push({identifier:s,updater:function(o,r){var n,t,e;{var i;e=r.singleton?(i=g++,n=u=u||p(r),t=h.bind(null,n,i,!1),h.bind(null,n,i,!0)):(n=p(r),t=function(r,o,n){var t=n.css,e=n.media,n=n.sourceMap;e?r.setAttribute("media",e):r.removeAttribute("media");n&&"undefined"!=typeof btoa&&(t+="\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(n))))," */"));if(r.styleSheet)r.styleSheet.cssText=t;else{for(;r.firstChild;)r.removeChild(r.firstChild);r.appendChild(document.createTextNode(t))}}.bind(null,n,r),function(){var r;null!==(r=n).parentNode&&r.parentNode.removeChild(r)})}return t(o),function(r){r?r.css===o.css&&r.media===o.media&&r.sourceMap===o.sourceMap||t(o=r):e()}}(i,o),references:1}),t.push(s)}return t}function p(r){var o,n=document.createElement("style"),t=r.attributes||{};if(void 0!==t.nonce||(o=e.nc)&&(t.nonce=o),Object.keys(t).forEach(function(r){n.setAttribute(r,t[r])}),"function"==typeof r.insert)r.insert(n);else{r=i(r.insert||"head");if(!r)throw new Error("Couldn't find a style target. This probably means that the value for the 'insert' parameter is invalid.");r.appendChild(n)}return n}var l,A=(l=[],function(r,o){return l[r]=o,l.filter(Boolean).join("\n")});function h(r,o,n,t){n=n?"":t.media?"@media ".concat(t.media," {").concat(t.css,"}"):t.css;r.styleSheet?r.styleSheet.cssText=A(o,n):(t=document.createTextNode(n),(n=r.childNodes)[o]&&r.removeChild(n[o]),n.length?r.insertBefore(t,n[o]):r.appendChild(t))}var u=null,g=0;r.exports=function(r,i){(i=i||{}).singleton||"boolean"==typeof i.singleton||(i.singleton=a());var l=s(r=r||[],i);return function(r){if(r=r||[],"[object Array]"===Object.prototype.toString.call(r)){for(var o=0;o<l.length;o++){var n=d(l[o]);c[n].references--}for(var r=s(r,i),t=0;t<l.length;t++){var e=d(l[t]);0===c[e].references&&(c[e].updater(),c.splice(e,1))}l=r}}}},"./src/opacity.png":
/*!*************************!*\
  !*** ./src/opacity.png ***!
